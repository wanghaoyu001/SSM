<%@ page language="java" import="com.pojo.*,java.util.*" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
...
<title>采购进货</title>
<!-- css引入 -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/statics/css/buyin.css" type="text/css"/>
<!-- jquery引入 -->
